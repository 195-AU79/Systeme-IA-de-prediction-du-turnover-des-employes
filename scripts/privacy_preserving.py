...
from paths import get_config_path, get_data_path, get_db_path
import warnings
...
class PrivacyPreservingSystem:
    ...
    def save_anonymization_mapping(self):
        ...
        try:
            with open(get_data_path('anonymization_mapping.json'), 'w') as f:
    ...
    def load_anonymization_mapping(self):
        ...
        try:
            with open(get_data_path('anonymization_mapping.json'), 'r') as f:
    ...
    def create_anonymized_dataset(self, input_db_path: str, output_db_path: str):
        ...
        try:
            ...
            with open(get_data_path('anonymization_metadata.json'), 'w') as f:
    ...
    def audit_data_access(self, user_id: str, action: str, data_type: str, records_count: int):
        ...
        try:
            ...
            try:
                with open(get_data_path('data_access_audit.json'), 'r') as f:
            ...
            # Sauvegarder
            with open(get_data_path('data_access_audit.json'), 'w') as f:
    ...
    def generate_privacy_report(self):
        ...
        try:
            ...
            with open(get_data_path('privacy_report.json'), 'w') as f:
    ...
    while True:
        ...
        if choice == '1':
            ...
            privacy_system.create_anonymized_dataset(
                get_db_path(),
                get_data_path('turnover_data_anonymized.db')
            )
