...
class ContinuousLearningSystem:
    ...
    def load_current_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            le_dept = joblib.load('label_encoder_department.pkl')
            le_level = joblib.load('label_encoder_job_level.pkl')
    ...
    def save_models(self, training_results: Dict[str, Any]):
        ...
        try:
            ...
            joblib.dump(training_results['models'], 'all_models.pkl')
            
            # Sauvegarder le meilleur modèle
            joblib.dump(training_results['best_model'], 'best_ensemble_model.pkl')
            
            # Sauvegarder le scaler
            joblib.dump(training_results['scaler'], 'scaler.pkl')
            
            # Sauvegarder les résultats
            with open('continuous_learning_results.json', 'w') as f:
                json.dump({
    ...
    def backup_current_models(self):
        ...
        try:
            ...
            try:
                current_models = joblib.load('all_models.pkl')
                joblib.dump(current_models, f'backup_models_{timestamp}.pkl')
            except:
                pass
            
            try:
                current_scaler = joblib.load('scaler.pkl')
                joblib.dump(current_scaler, f'backup_scaler_{timestamp}.pkl')
            except:
                pass
    ...
    def check_data_drift(self) -> bool:
        ...
        try:
            ...
            try:
                with open('data_reference.json', 'r') as f:
    ...
    def retrain_models(self):
        ...
        try:
            ...
            if current_models:
                ...
                try:
                    with open('continuous_learning_results.json', 'r') as f:
